...
#ifndef testLinkedListSequence_h
#define testLinkedListSequence_h
...
public:
    TestLinkedListSequence() : is_correct_(true) {}
...
bool TestLinkedListSequence::isCorrect() const noexcept {
    return is_correct_;
}

void TestLinkedListSequence::testGetFirst() noexcept {
    UnqPtr<int[]> ar(new int[2]{1, 2});
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 2));
    int first1 = s1->getFirst();
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>);
...
void TestLinkedListSequence::testGetLast() noexcept {
    UnqPtr<int[]> ar(new int[2]{1, 2});
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 2));
...
void TestLinkedListSequence::testGet() noexcept {
    UnqPtr<int[]> ar(new int[4]{1, 2, 3, 4});
    UnqPtr<Sequence<int>> s = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 4));
    int el1 = s->get(2);
...
void TestLinkedListSequence::testGetSubSequence() noexcept {
    int* ar = new int[7]{1, 2, 3, 4, 5, 6, 7};
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 7));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar + 2, 3));
...
void TestLinkedListSequence::testGetLength() noexcept {
...
void TestLinkedListSequence::testAppend() noexcept {
    UnqPtr<int[]> ar(new int[5]{1, 2, 3, 4, 5});
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 5));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 4));
    s2->append(5);

    UnqPtr<Sequence<int>> s3 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 1));
    UnqPtr<Sequence<int>> s4 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>);
    s4->append(1);
...
void TestLinkedListSequence::testPrepend() noexcept {
    int* ar = new int[5]{1, 2, 3, 4, 5};
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 5));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar + 1, 4));
    s2->prepend(1);
...
void TestLinkedListSequence::testInsertAt() noexcept {
    UnqPtr<int[]> ar1(new int[4]{1, 2, 4, 5});

    UnqPtr<int[]> ar2(new int[5]{1, 2, 3, 4, 5});

    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar1, 4));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar2, 5));
    s1->insertAt(3, 2);
...
void TestLinkedListSequence::testDeleteElement() noexcept {
    int *ar = new int[3]{1, 2, 3};
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 3));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar + 1, 2));
    UnqPtr<Sequence<int>> s3 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar + 1, 1));
    UnqPtr<Sequence<int>> s4 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>);
    bool correct1 = false;
    try {
        s1->deleteElement(-2);
...
void TestLinkedListSequence::testSet() noexcept {
    int *ar = new int[3]{1, 2, 3};
    UnqPtr<Sequence<int>> s = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 3));
    bool correct1 = false;
    try {
        s->set(-2, 0);
    }
...
void TestLinkedListSequence::testConcat() noexcept {
    int *ar = new int[5]{1, 2, 3, 4, 5};
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 2));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar + 2, 3));
    UnqPtr<Sequence<int>> s3 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 5));
    UnqPtr<Sequence<int>> s4 = s1->concat(*s2);
    UnqPtr<Sequence<int>> s5 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>);
...
void TestLinkedListSequence::testOperatorGet() noexcept {
...
void TestLinkedListSequence::testOperatorConcat() noexcept {
    int *ar = new int[5]{1, 2, 3, 4, 5};
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 2));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar + 2, 3));
    UnqPtr<Sequence<int>> s3 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 5));
...
void TestLinkedListSequence::testOperatorCompare() noexcept {
    int *ar = new int[4]{1, 2, 3, 4};
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 4));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>);
    UnqPtr<Sequence<int>> s3 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar, 3));
    s3->append(10);
...
void TestLinkedListSequence::testMap() noexcept {
    UnqPtr<int[]> ar1 = UnqPtr<int[]>(new int[4]{1, 2, 3, 4});
    UnqPtr<int[]> ar2 = UnqPtr<int[]>(new int[4]{2, 4, 6, 8});
    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar1, 4));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar2, 4));
...
void TestLinkedListSequence::testWhere() noexcept {
    UnqPtr<int[]> ar1 = UnqPtr<int[]>(new int[8]{4, 2, 9, 13, 42, -4, 5, 1});
    UnqPtr<int[]> ar2 = UnqPtr<int[]>(new int[8]{4, 2, 42, -4});

    UnqPtr<Sequence<int>> s1 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar1, 8));
    UnqPtr<Sequence<int>> s2 = UnqPtr<Sequence<int>>(new LinkedListSequence<int>(ar2, 4));
...
void TestLinkedListSequence::testReduce() noexcept {
